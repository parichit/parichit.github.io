...
window.SITE = {
  ...
  publications: {
    ...
    items: [
      ...
      {
        authors: "**Parichit Sharma**, Marcin M. Stanislaw, Hasan Kurban, Oguzhan Kulekci, and Mehmet Dalkilic",
      ...
      {
        authors: "Hasan Kurban, **Parichit Sharma**, Mustafa Kurban, and Mehmet Dalkilic",
        title:   "Accelerating Density of States Prediction in Zn-Doped MgO Nanoparticles via Kernel-Optimized Weighted k-NN",
      ...
      {
        authors: "**Parichit Sharma**, Sarthak Mishra, Hasan Kurban, Mehmet M. Dalkilic",
        title:   "p-ClustVal: A Novel p-adic Approach for Enhanced Clustering and Valuation in High-Dimensional scRNASeq Data",
        venue:   "International Journal of Data Science and Analytics (IJDSA), Springer",
        year:    "2025",
        featured: false,
        // links: { pdf: "#", code: "https://github.com/", bibtex: "", project: "" },
      },
      {
        authors: "**Parichit Sharma**, Hasan Kurban, Mehmet Dalkilic, Mustafa Kurban",
        ...
        venue:   "IEEE International Conference on Compatibility, Power Electronics and Power Engineering",
        year:    "2025",
        featured: false,
        // links: { pdf: "#", code: "https://github.com/", bibtex: "", project: "" },
      },
      {
        authors: "Mert O. Cakiroglu, Hasan Kurban, **Parichit Sharma**, M. Oguzhan Kulekci, Elham K. Buxton, Maryam R. Sarmazdeh, and Mehmet Dalkilic",
      ...
      {
        authors: "**Parichit Sharma**, Sarthak Mishra, Hasan Kurban, Mehmet M. Dalkilic",
        title:   "p-ClustVal: A Novel p-adic Approach for Enhanced Clustering and Valuation in High-Dimensional scRNASeq Data (Extended Abstract)",
        venue:   "**(IEEE DSAA)** The 11th IEEE International Conference on Data Science and Advanced Analytics, San Diego, USA",
        year:    "2024",
        featured: false,
        // links: { pdf: "#", code: "https://github.com/", bibtex: "", project: "" },
      },
      {
        authors: "**Parichit Sharma**, Hasan Kurban and Mehmet M. Dalkilic",
        title:   "What Data-Centric AI Can Do For k-means: a Faster, Robust k-means-d",
        venue:   "**(ICML)** The 41st International Conference on Machine Learning (ICML), Data- centric Machine Learning Research (DMLR): Datasets for Foundation Models, Vienna, Austria",
        year:    "2024",
        featured: false,
        // links: { pdf: "#", code: "https://github.com/", bibtex: "", project: "" },
      },
      {
        authors: "Ganesh Arkanath, Nishad Gupta, Hasan Kurban, **Parichit Sharma**, Madhavan K R, Elham Khorasani Buxton and Mehmet M. Dalkilic",
        title:   "Novel NBA Fantasy League driven by Engineered Team Chemistry and Scaled Position Statistics",
        venue:   "IEEE International Conference on Big Data: Data-Centric AI, Sorrento, Italy",
        year:    "2023",
        featured: false,
        // links: { pdf: "#", code: "https://github.com/", bibtex: "", project: "" },
      },
      {
        authors: "Anshumaan Shankar, Gowtham Veerabadran Rajasekaran, Jacob Hendricks, Jared Andrew Schlak, **Parichit Sharma**, Madhavan K R, Hasan Kurban and Mehmet M. Dalkilic",
        title:   "Are Sports Awards About Sports? Using AI to Find the Answer",
        venue:   "**(ECML/PKDD)** European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases: 10th Workshop on Machine Learning and Data Mining for Sports Analytics, Turin, Italy",
        year:    "2023",
        featured: false,
        // links: { pdf: "#", code: "https://github.com/", bibtex: "", project: "" },
      },
      {
        authors: "Josh Elms, Sam Johnson, Madhavan K R, Keerthana Sugasi, **Parichit Sharma**, Hasan Kurban and Mehmet M. Dalkilic",
        title:   "AReS: An AutoML Regression Service for Data Analytics and Novel Data-centric Visualizations",
        venue:   "**(KDD-UC)**,29th ACM SIGKDD International Conference on Knowledge Discovery and Data Mining, Undergrad- uate Consortium, Long Beach, CA, USA",
        year:    "2023",
        featured: false,
        // links: { pdf: "#", code: "https://github.com/", bibtex: "", project: "" },
      },
      {
        authors: "Sam Johnson, Josh Elms, Madhavan K R, Keerthana Sugasi, **Parichit Sharma**, Hasan Kurban and Mehmet M. Dalkilic",
        ...
        venue:   "**(KDD-UC)**,29th ACM SIGKDD International Conference on Knowledge Discovery and Data Mining, Undergraduate Consortium, Long Beach, CA, USA",
        year:    "2023",
        featured: false,
        // links: { pdf: "#", code: "https://github.com/", bibtex: "", project: "" },
      },
      ...
      {
        authors: "Hasan Kurban, **Parichit Sharma** and Mehmet M. Dalkilic",
        title:   "Data Expressiveness and Its Use in Data-centric AI",
        venue:   "**(Neurips)** 35th Conference on Neural Information Processing Systems Data-centric AI, Sydney, Australia",
        year:    "",
        featured: false,
        // links: { pdf: "#", code: "https://github.com/", bibtex: "", project: "" },
      },
      {
        authors: "Hasan Kurban, Mustafa Kurban, **Parichit Sharma**, and Mehmet M. Dalkilic",
